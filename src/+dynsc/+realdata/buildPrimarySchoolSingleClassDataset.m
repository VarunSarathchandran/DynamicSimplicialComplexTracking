function dataset = buildPrimarySchoolSingleClassDataset(cfg)
%BUILDPRIMARYSCHOOLSINGLECLASSDATASET Construct a within-class empirical SC.
...
selection = dynsc.realdata.selectSingleClassCohort( ...
...
dataset.description = ...
    "Single-class empirical contact topology with synthetic signals.";
